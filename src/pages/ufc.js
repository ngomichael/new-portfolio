...
const overview = {
  ...
  description: [
    `My project does exactly what the name suggests, it displays UFC statistics.
  ...
  pick a fighter the application routes you to another page where you are able to see 6 different statistics for
  ...
  the end of this project and had so much fun immersing myself in different technologies.
  ...
  techDescription: [
    ...
    me to create components that are dynamic and interactive was when I understood that state 
    ...
    One problem that I saw arising when creating this app was prop drilling and Redux would solve that. 
    Even though in this app I was creating it didn't get to the point where it needed Redux just yet, I 
    wanted to incorporate it into my app to learn how to use it and to have the skills when I built an app that actually needed it. What I
    ...
    <br />,
    <br />,
    `Even though there aren't many parts to Redux, wrapping my head around the flow and how 
    ...
    Redux incorporated into my app was when I started to better understand what was happening.
    Getting all the small pieces working together was what really helped me figure out how Redux operated.`,
    ,
  ],
  ...
  imgs: [
    ...
    },
    {
      ...
      caption: `Statistics page where the fighter's statistics and information are displayed`,
    },
  ],
