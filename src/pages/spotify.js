...
const overview = {
  ...
  and a thing or two that I want to learn. This time it was Spotify and RESTful APIs. I
  learned how to interact with APIs and work with asynchronous data. I'm glad that I was exposed to this early, because
  at that time I didn't know that I would be working with APIs and asynchronous data so often.`,
  ],
  techDescription: [
    <h3>jQuery </h3>,
    ...
    This felt very familiar to me because just like using `,
    <CodeSnippet>document.getElementById</CodeSnippet>,
    ` I would use `,
    <CodeSnippet>$('#className')</CodeSnippet>,
    ` instead. jQuery was a little funny looking at first with all of the dollar signs,
    but otherwise it was easy to use and understand.
    `,
    <br />,
    <br />,
    <h3>Spotify API and Asynchronous Data</h3>,
    `Until this point I haven't had to work with with asynchronous behavior.
    My first time was when I started to make requests to Spotify's REST API. I used
    jQuery's ajax function to make GET requests to Spotify's API to get an artist's songs,
    image, and related artists.`,
    <br />,
    <br />,
    `Learning about the different types of requests and headers, and how to retrieve 
    the data I needed from the response was a great learning experience, but not easy at the time. 
    ...
    I would have liked to have added features that would have utilized other API methods so
